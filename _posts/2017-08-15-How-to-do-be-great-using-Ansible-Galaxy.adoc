...
So Ansible Galaxy can help you with: (a) learn by example by looking on the code other people already provided and; (b) create great playbooks by orchestrating with roles done by the community.
...
It's time to enter in the arena and put some bytes to working on. You have to create your project.
